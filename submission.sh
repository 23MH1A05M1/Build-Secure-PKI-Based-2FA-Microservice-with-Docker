#!/bin/bash
repo_url=https://github.com/23MH1A05M1/Build-Secure-PKI-Based-2FA-Microservice-with-Docker
...
echo "Docker image URL for evaluation: bhagyasri1805/build-secure-pki-based-2fa-microservice-with-docker-app:latest"
echo "Docker Hub link: https://hub.docker.com/r/bhagyasri1805/build-secure-pki-based-2fa-microservice-with-docker-app"